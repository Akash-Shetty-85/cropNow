...
const content = [
  {
    title: "Who We Are",
    description:
      "At CropNow, we believe that agriculture should be smarter, more efficient, and sustainable for generations to come. We’re not just another agri-tech company—we’re a team passionate about empowering farmers with the right tools to make their work easier and more rewarding. Our mission is simple: to help farmers grow more with less, using technology that enhances productivity, conserves resources, and supports eco-friendly farming practices.",
    content: (
      <div
